...
from dynamic_functions.Game.Content.KittyLobby.checkin import (
    get_visit_info,
    is_checkin_complete,
...
def get_checkin_context(caller: str) -> Dict[str, Any]:
    """Figure out what Kitty needs to do for this caller.
    ...
    Returns {
        ...
        'suppress_caller_name': bool,  # hide username until security clears them
    }
    """
