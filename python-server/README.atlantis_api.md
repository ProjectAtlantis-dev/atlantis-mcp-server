...
| `get_script_folder()` | `str` | Stable absolute executing-script folder as `/username/remote/folder`. Root-level scripts return `/username/remote`; returns `None` outside dynamic-function context. |
