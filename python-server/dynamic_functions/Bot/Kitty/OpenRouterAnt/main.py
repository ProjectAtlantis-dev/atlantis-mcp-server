...
_BUSY_KEY = "kitty_orant_busy_sessions"
    ...
    try:
        ...
        try:
            while turn_count < max_turns:
                ...
                logger.info(f"=== SENDING TO OPENROUTER (ANTHROPIC) (turn {turn_count}) ===")
                ...
                with client.messages.stream(
                    ...
                    logger.info(f"<<< OpenRouter stream opened in {_t.monotonic() - t_api:.2f}s, reading events...")
                    if turn_count == 1:
